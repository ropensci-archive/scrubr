...
#>  1 1840… Lepidoptera               25.0             121. txmat… e0b8cb67-…
#>  2 1981… Geometridae               24.2             121. txmat… e0b8cb67-…
#>  3 1981… Nolidae                   25.1             121. txmat… e0b8cb67-…
#>  4 1981… Lepidoptera               25.0             122. txmat… e0b8cb67-…
#>  5 1981… Crambidae                 24.2             121. txmat… e0b8cb67-…
#>  6 1981… Erebidae                  25.0             122. txmat… e0b8cb67-…
#>  7 1981… Lepidoptera               24.9             121. txmat… e0b8cb67-…
#>  8 1981… Lepidoptera               25.0             122. txmat… e0b8cb67-…
#>  9 1981… Lepidoptera               25.0             122. txmat… e0b8cb67-…
#> 10 1981… Lepidoptera               24.9             121. txmat… e0b8cb67-…
#> # … with 100 more rows, and 104 more variables: publishingOrgKey <chr>,
...
#> #   taxonRank <chr>, taxonomicStatus <chr>, dateIdentified <chr>, year <int>,
#> #   month <int>, eventDate <chr>, modified <chr>, lastInterpreted <chr>,
#> #   references <chr>, license <chr>, class <chr>, countryCode <chr>,
#> #   country <chr>, rightsHolder <chr>, identifier <chr>, habitat <chr>,
#> #   verbatimEventDate <chr>, gbifID <chr>, collectionCode <chr>,
#> #   language <chr>, verbatimLocality <chr>, occurrenceID <chr>, type <chr>,
#> #   catalogNumber <chr>, institutionCode <chr>, identificationRemarks <chr>,
#> #   identifiedBy <chr>, identificationID <chr>, stateProvince <chr>,
#> #   geodeticDatum <chr>, elevation <dbl>, continent <chr>, county <chr>,
#> #   datasetName <chr>, eventRemarks <chr>, fieldNumber <chr>, recordedBy <chr>,
#> #   coordinateUncertaintyInMeters <dbl>, day <int>,
#> #   `http://unknown.org/nick` <chr>, taxonID <chr>,
#> #   `http://unknown.org/occurrenceDetails` <chr>, rights <chr>,
#> #   eventTime <chr>, occurrenceRemarks <chr>, elevationAccuracy <dbl>,
#> #   recordNumber <chr>, locality <chr>, municipality <chr>,
#> #   ownerInstitutionCode <chr>, higherGeography <chr>, islandGroup <chr>,
#> #   vernacularName <chr>, higherClassification <chr>, individualCount <int>,
#> #   identificationVerificationStatus <chr>, occurrenceStatus <chr>,
#> #   taxonConceptID <chr>, behavior <chr>, informationWithheld <chr>,
#> #   endDayOfYear <chr>, startDayOfYear <chr>, originalNameUsage <chr>,
#> #   datasetID <chr>, accessRights <chr>, associatedReferences <chr>,
#> #   verbatimElevation <chr>, eventID <chr>, otherCatalogNumbers <chr>,
#> #   dataGeneralizations <chr>, lifeStage <chr>, associatedTaxa <chr>,
#> #   name <chr>, …
```
